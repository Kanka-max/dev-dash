                            ...
                            dbc.Col(
                                [
                                    html.Div(
                                        [
                                            html.H5("Total Posts"),
                                            html.H2(id='content-total-posts', children=""), #the value of the total harmful users
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.H2(id='content-harmful-posts', children=""), #the value of the total harmful users
                                            # html.H6("(5.53%)") #percentage
                                        ],className="card",
                                    )
                                ]
                            ...
                            dbc.Col(
                                [
                                    ...
                                    html.Div(
                                        [
                                            html.H5("Total Users"),
                                            html.H2(id='content-total-users', children=""), #the value of the total harmful users
                                            # html.H6("(5.53%)") #percentage
                                        ],className="card",
                                    )
                                ]
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.H2(id='content-harmful-users', children=""), #the value of the total harmful users
                                            # html.H6("(5.53%)") #percentage
                                        ],className="card",
                                    )
                                ]
...
def update_stacked_chart(start_date, end_date, value_chosen):
    ...
    return {
        ...
        'layout': go.Layout(
            barmode = 'group',
            yaxis={'title':'Total Count of Posts'},
            xaxis={'title':'Date'},
            titlefont= dict(
                family='Open Sans',
                color='#000000',
...
def update_horizontal_chart(start_date, end_date, value_chosen):
    ...
    return {
        ...
        'layout': go.Layout(
            ...
            xaxis={'title':'Harmful Language Categories'},
            titlefont= dict(
                family='Open Sans',
                color='#000000',
                size=12
...
def update_line_chart(start_date, end_date, value_chosen):
    ...
    combined_t4 = combined_t3.groupby(['date','annotation'])['harmful_annotation_count'].count()
    combined_t5 = combined_t4.reset_index()

    fig_line = px.line(combined_t5, x= 'date', y = 'harmful_annotation_count', color='annotation', 
    ...
    fig_line.update_layout( margin=dict(l=20),
                                #r=20, t=30, b=20), 
                            yaxis= dict(title = '<b>Harmful Language Categories</b>',
                            color='#000000',
                            showline=True,
                            linecolor='#000000',
                            ),
